...
def initialize_julia(python_path):
    ...
    Main.eval("using ACEpotentials: load_model, set_committee!, @committee")

    Main.eval("using ACEpotentials.Models: set_linear_parameters!")

    Main.eval("set_params(model, params) = ACEpotentials.Models.set_linear_parameters!(model, params)")
